...
import { MAX_WIDTH_BREAKPOINT, MAX_HEIGHT_BREAKPOINT } from 'src/app/Breakpoints';
    ...
    useEffect(() => {
        function handleResize() {
            ...
            if (window.innerHeight > maxHeight || isNaN(maxHeight)) {
                localStorage.setItem(LOCAL_STORAGE_KEYS.MAX_HEIGHT, JSON.stringify(window.innerHeight));
            }
        }
