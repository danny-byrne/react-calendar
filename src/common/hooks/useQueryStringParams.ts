...
export const useQueryStringParams = (): useQueryStringParamsReturn => {
    ...
    const addSearchParam = (object: Object) => {
        setSearchParams(Object.assign({}, Object.fromEntries(searchParams.entries()), object), { replace: true });
    };
    ...
    const removeSearchParam = (key: string) => {
        ...
        setSearchParams(Object.fromEntries(searchParams.entries()), { replace: true });
    };

    return { searchParams: params, getSearchParam, addSearchParam, removeSearchParam };
};
