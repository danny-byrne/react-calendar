...
export type CareCircleMembers = GetMemberQuery['usersCareCircle']['careCircleMembers'];
export type UserData = GetMemberQuery['usersCareCircle']['careCircleMembers'][0];
export type CareGiver = GetMemberQuery['usersCareCircle']['careCircleMembers'][0]['careGiver'];
export type Profile = GetMemberQuery['usersCareCircle']['careCircleMembers'][0]['profile'];
