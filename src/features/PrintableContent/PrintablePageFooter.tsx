...
const PrintablePageFooter: React.FC<IPageFooterProps> = ({ includePageBreak, pageNumber, recipientData }) => {
    ...
    return (
        <Stack className={classNames['wc-PrintableContent--footerContent']}>
            ...
            <Stack horizontal horizontalAlign="space-between">
                ...
                <Stack horizontal tokens={stackTokens} className={classNames['wc-PrintableContent--msLogo']}>
            ...
            {includePageBreak && <div className={classNames['wc-PrintableContent--pageBreak']} />}
        </Stack>
    );
};
