...
import { useDeleteMedicationMutation, useEndMedicationMutation } from 'src/graphQL/serverMocks/graphQLGeneratedCode';
...
const DELETE = 'delete';
const THEY_ARE_NO_LNGER_TAKING_TEXT = 'They are no longer taking this medication';
...
const EndMedicationDialog: React.FC<DeleteDialogProps> = ({ hidden, toggleHideDialog, id }) => {
