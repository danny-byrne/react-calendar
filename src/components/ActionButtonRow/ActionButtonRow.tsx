...
const ActionButtonRow: React.FC<IActionButtonRowProps> = ({ onDelete, hideSeparator = false, inLine = false }) => {
    ...
    return (
        <>
            ...
            {!hideSeparator && <Separator className={classNames['wc-ActionButtonRow--buttonSeparator']} />}
        </>
    );
};
