...
export const DocumentEditPanelContainerWithHeader: React.FC<
  IDocumentEditPanelContainerWithHeaderProps
> = ({
  title,
  ...
  return (
    <Stack
      className={classNames["wc-PanelContainerWithHeader--subHeaderContainer"]}
    >
      <SubHeaderLayout
        title={title}
